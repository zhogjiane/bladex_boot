...
public class ProductInfoController extends BladeController {
	...
	public R<IPage<ProductInfo>> list(ProductInfo productInfo, Query query) {
		IPage<ProductInfo> pages = productInfoService.page(Condition.getPage(query),
			Condition.getQueryWrapper(productInfo));
		return R.data(pages);
	}
	...
	public R<IPage<ProductInfoVO>> page(ProductInfoVO productInfo, Query query) {
		IPage<ProductInfoVO> pages = productInfoService.selectProductInfoPage(
			Condition.getPage(query), productInfo);
		return R.data(pages);
	}
