 ...
 */
@Service
public class ProductServiceRecordServiceImpl extends ServiceImpl<ProductServiceRecordMapper, ProductServiceRecord> implements IProductServiceRecordService {

	@Override
	public IPage<ProductServiceRecordVO> selectProductServiceRecordPage(IPage<ProductServiceRecordVO> page, ProductServiceRecordVO productServiceRecord) {
		return page.setRecords(baseMapper.selectProductServiceRecordPage(page, productServiceRecord));
	}
