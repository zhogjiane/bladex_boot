 ...
 */
package org.springblade.modules.system.filemessage.service;
...
public interface IFileMessageService extends IService<FileMessage> {
	 ...
	 * @return
	 */
	IPage<FileMessageVO> selectFileMessagePage(IPage<FileMessageVO> page, FileMessageVO fileMessage);
